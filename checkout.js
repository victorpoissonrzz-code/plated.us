...
// Allowed shipping countries — set to "all" mode by passing every ISO-2 code
// that Stripe Checkout supports. We include the full list so customers worldwide
// can buy. (Cuba, Iran, North Korea, Syria are excluded by Stripe itself due to
// US sanctions and don't need to be omitted manually.)
